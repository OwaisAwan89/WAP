                        ...
                        <div class="card-body">
                            ...
                            <form class="user" method="POST" action="billPay">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <input id="billNumber3" type="text" name ="billNumber" class="form-control bg-light border-0 small" placeholder="Enter bill Number" aria-label="Search" aria-describedby="basic-addon2">
